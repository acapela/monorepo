...
import { getTeamSlackInstallationURL, slackUser } from "~backend/src/slack/hasuraActions";
...
export const handlers: ActionHandler<any, any>[] = [getTeamSlackInstallationURL, getUploadUrl, inviteUser, slackUser];
