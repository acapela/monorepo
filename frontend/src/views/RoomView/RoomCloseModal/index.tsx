...
export const closeOpenTopicsPrompt = createPromiseUI<RoomEntity, RoomCloseModalResult>((room, resolve) => {
  ...
  const columnsOfTopics = splitTopicsIntoColumns(room.topics.all);
