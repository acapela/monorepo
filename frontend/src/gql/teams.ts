...
>(
  ...
  {
    onActualResponse() {
      addToast({ type: "success", content: `New team member was invited` });
    },
  }
);
...
>(
  ...
  `,
  {
    ...
    onActualResponse() {
      addToast({ type: "success", content: `Team invitation was removed` });
    },
  }
);
...
>(
  ...
  `,
  {
    ...
    onActualResponse() {
      addToast({ type: "success", content: `Team member was removed` });
    },
  }
);
...
export const [useResendInvitation] = createMutation<ResendInvitationMutation, ResendInvitationMutationVariables>(
  ...
  {
    onActualResponse() {
      addToast({ type: "success", content: `Team invitation was sent` });
    },
  }
);
