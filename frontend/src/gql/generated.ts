...
export type AcceptInviteMutation = { __typename?: "mutation_root" } & {
  invite?: Maybe<{ __typename?: "InviteAcceptResponse" } & { roomId: InviteAcceptResponse["room_id"] }>;
};

export type GetRoomsTestQueryQueryVariables = Exact<{ [key: string]: never }>;

export type GetRoomsTestQueryQuery = { __typename?: "query_root" } & {
  room: Array<{ __typename?: "room" } & Pick<Room, "id">>;
};

export type RoomBasicInfoFragment = { __typename?: "room" } & Pick<Room, "id" | "name"> & {
    participants: Array<
      { __typename?: "room_participants" } & {
...
export type RoomDetailedInfoFragment = { __typename?: "room" } & Pick<Room, "id" | "name"> & {
    participants: Array<
      { __typename?: "room_participants" } & {
        user: { __typename?: "user" } & Pick<User, "id" | "name"> & { avatarUrl: User["avatar_url"] };
      }
...
export type GetRoomsQuery = { __typename?: "query_root" } & {
...
export type GetSingleRoomQuery = { __typename?: "query_root" } & {
...
export type CreateRoomMutation = { __typename?: "mutation_root" } & {
  room?: Maybe<{ __typename?: "room" } & Pick<Room, "id">>;
};
...
export type CreateThreadMutation = { __typename?: "mutation_root" } & {
  thread?: Maybe<{ __typename?: "thread" } & Pick<Thread, "id">>;
};
...
export type GetRoomInvitesQuery = { __typename?: "query_root" } & {
  invites: Array<
...
export type CreateTextMessageMutation = { __typename?: "mutation_root" } & {
  message?: Maybe<{ __typename?: "message" } & ThreadMessageBasicInfoFragment>;
};
...
export type ThreadMessagesSubscription = { __typename?: "subscription_root" } & {
  messages: Array<{ __typename?: "message" } & ThreadMessageBasicInfoFragment>;
};
...
export type mutation_rootKeySpecifier = (
  ...
  | "delete_room_participants_by_pk"
  | "delete_thread"
  | "delete_thread_by_pk"
  | "delete_user"
  | "delete_user_by_pk"
...
export type room_participants_aggregateKeySpecifier = (
  | "aggregate"
  | "nodes"
  | room_participants_aggregateKeySpecifier
)[];
export type room_participants_aggregateFieldPolicy = {
  aggregate?: FieldPolicy<any> | FieldReadFunction<any>;
  nodes?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type room_participants_aggregate_fieldsKeySpecifier = (
  | "count"
  | "max"
  | "min"
  | room_participants_aggregate_fieldsKeySpecifier
)[];
...
export type room_participants_max_fieldsKeySpecifier = (
  | "room_id"
  | "user_id"
  | room_participants_max_fieldsKeySpecifier
)[];
export type room_participants_max_fieldsFieldPolicy = {
  room_id?: FieldPolicy<any> | FieldReadFunction<any>;
  user_id?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type room_participants_min_fieldsKeySpecifier = (
  | "room_id"
  | "user_id"
  | room_participants_min_fieldsKeySpecifier
)[];
export type room_participants_min_fieldsFieldPolicy = {
  room_id?: FieldPolicy<any> | FieldReadFunction<any>;
  user_id?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type room_participants_mutation_responseKeySpecifier = (
  | "affected_rows"
  | "returning"
  | room_participants_mutation_responseKeySpecifier
)[];
...
export type threadKeySpecifier = (
  | "id"
  | "index"
  | "messages"
  | "messages_aggregate"
...
export type thread_mutation_responseKeySpecifier = (
  | "affected_rows"
  | "returning"
  | thread_mutation_responseKeySpecifier
)[];
...
export type TypedTypePolicies = TypePolicies & {
  ...
  room_participants_aggregate?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | room_participants_aggregateKeySpecifier
      | (() => undefined | room_participants_aggregateKeySpecifier);
  ...
  room_participants_aggregate_fields?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | room_participants_aggregate_fieldsKeySpecifier
      | (() => undefined | room_participants_aggregate_fieldsKeySpecifier);
  ...
  room_participants_max_fields?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | room_participants_max_fieldsKeySpecifier
      | (() => undefined | room_participants_max_fieldsKeySpecifier);
  ...
  room_participants_min_fields?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | room_participants_min_fieldsKeySpecifier
      | (() => undefined | room_participants_min_fieldsKeySpecifier);
  ...
  room_participants_mutation_response?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | room_participants_mutation_responseKeySpecifier
      | (() => undefined | room_participants_mutation_responseKeySpecifier);
...
`;
export type CreateTextMessageMutationFn = Apollo.MutationFunction<
...
export type CreateTextMessageMutationOptions = Apollo.BaseMutationOptions<
  CreateTextMessageMutation,
  CreateTextMessageMutationVariables
>;
