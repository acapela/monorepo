...
function SvgArrowBottomLeftCircle(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgArrowBottomLeftCircle = React.memo(SvgArrowBottomLeftCircle);
export default MemoSvgArrowBottomLeftCircle;
