...
function SvgComment2Cancel(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgComment2Cancel = React.memo(SvgComment2Cancel);
export default MemoSvgComment2Cancel;
