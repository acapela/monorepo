...
function SvgArrowTopLeftCircle(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgArrowTopLeftCircle = React.memo(SvgArrowTopLeftCircle);
export default MemoSvgArrowTopLeftCircle;
