...
export interface Full_Text_Search_Bool_Exp {
  _and?: Maybe<Array<Full_Text_Search_Bool_Exp>>;
  _not?: Maybe<Full_Text_Search_Bool_Exp>;
  _or?: Maybe<Array<Full_Text_Search_Bool_Exp>>;
...
export interface Transcription_Full_Text_Bool_Exp {
  _and?: Maybe<Array<Transcription_Full_Text_Bool_Exp>>;
  _not?: Maybe<Transcription_Full_Text_Bool_Exp>;
  _or?: Maybe<Array<Transcription_Full_Text_Bool_Exp>>;
  transcript?: Maybe<String_Comparison_Exp>;
  transcription_id?: Maybe<Uuid_Comparison_Exp>;
}
...
export type team_memberKeySpecifier = ('id' | 'team' | 'team_id' | 'user' | 'user_id' | team_memberKeySpecifier)[];
...
export type userKeySpecifier = ('avatar_url' | 'created_at' | 'created_room_invitations' | 'created_room_invitations_aggregate' | 'created_rooms' | 'created_rooms_aggregate' | 'created_team_invitations' | 'created_team_invitations_aggregate' | 'current_team' | 'current_team_id' | 'email' | 'email_verified' | 'id' | 'messages' | 'messages_aggregate' | 'name' | 'notifications' | 'notifications_aggregate' | 'notify_email' | 'notify_slack' | 'owned_teams' | 'owned_teams_aggregate' | 'rooms' | 'rooms_aggregate' | 'space_memberships' | 'space_memberships_aggregate' | 'team_memberships' | 'team_memberships_aggregate' | 'topic_memberships' | 'topic_memberships_aggregate' | userKeySpecifier)[];
