DROP FUNCTION IF EXISTS public.search_full_text;
DROP FUNCTION IF EXISTS public.search_full_text_topic;

DROP MATERIALIZED VIEW IF EXISTS full_text_search;
...
SELECT room.id                  AS room_id,
       ...
       message.content_text     AS message_content,
...
FROM ((((((public.room
    ...
    LEFT JOIN public.message ON ((topic.id = message.topic_id)))
    LEFT JOIN public.attachment ON ((message.id = attachment.message_id)))
