...
export const previewLoadedChannel = createChannelBridge<{ url: string }>("preview-loaded");

export const previewUnattachedChannel = createChannelBridge<{ url: string }>("preview-unattached");
